 ...
 *
 * Each patch captures the diff between `origin/master` (or the ref given via
 ...
 *
 * Usage:
 *   node scripts/generate-patches.js              # compare against origin/master
 *   node scripts/generate-patches.js --base origin/master
 */
...
// Parse --base flag (default: origin/master)
const args = process.argv.slice(2);
const baseIdx = args.indexOf('--base');
const BASE_REF = baseIdx !== -1 && args[baseIdx + 1] ? args[baseIdx + 1] : 'origin/master';
